...
function startGame() {
    background = new component(480, 270, "img/mars.jpg", 0, 0, "image");
    myGamePiece = new component(80, 40, "img/tesla.png", 35, 120, "image");
    myGamePiece.gravity = 0.05;
    myScore = new component("30px", "Consolas", "blue", 10, 50, "text");
    myGameArea.start();
}
...
var myGameArea = {
    ...
    start: function() {
        ...
        this.canvas.setAttribute('id', 'canvas-element');
